...
void CameraPoseVisualization::setLineWidth(double width) { m_line_width = width; }
...
/*
void CameraPoseVisualization::add_image(const Eigen::Vector3d& T, const Eigen::Matrix3d& R, const cv::Mat
&src)
{
    //image.points.clear();
    //image.colors.clear();
